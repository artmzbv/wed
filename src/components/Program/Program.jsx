    ...
    <section className="program" id="программа">
      ...
      <div className="program__cards">
        ...
        <div className="program__card">
          <div className="program__item">
            <span className="program__value">
              Мы позаботились о вашем размещении в домиках на территории загородного клуба после мероприятия.  Детали о времени заселения и выселения сообщат наши организаторы ближе к дате торжества.<br />
            </span>
          </div>
          <div className="program__item">
            <span className="program__value">
